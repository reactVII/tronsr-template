...
* Go to https://github.com/tronscan/tronsr-template<h1 align="center"><h1 align="center">
  <br>
  <img width="40%" src="https://raw.githubusercontent.com/tron-explorer/docs/master/images/tron-banner.png">
  <br>
  RedMars Node_init Project in WooCommerce (React7.Store)
  <br>
</h1>
...
Super Representatives can use this template to build a static page which will be shown on RedMars Node_init. The link will be placed in the voting overview page right next to the name.
